...
name="custom-classes-transition"
  ...
  <div class="fansrebatedetail">
    <div class="title">
      <router-link to="/home/fans/fansdetail" class="fa icon-left back"></router-link>
      <span>详情</span>
    </div>
    <div class="main" >
      <div class="content">
        <div id="rebateDetail" class="data" v-if='consumeDetail'>
           <ul>
            <li  class="list" v-for="list in consumeDetail">
              <div class="date">
                <div class="day">{{list.add_time | formdata}}</div>
              </div>
              <div class="goods">{{list.goods_name | subStr }}</div>
              <div class="price">￥<span class="money">{{list.total_amount | subNum}}</span></div>
              <div class="stages">￥<span class="money">{{list.first_amount | subNum}}</span>x <span class="sta_num">{{list.stages_number}}</span>期</div>
            </li>
        ...
        <div v-if='!consumeDetail'>暂无数据......</div>
      </div>
